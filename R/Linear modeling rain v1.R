...
SikundurFilesDFAddWeather_wide <-
  read.csv('data/SikundurFilesDFAddWeather_wide_verifieddetects.csv')
...
ggpubr::ggscatter(
  ...
  x = 'precip_am',  # X-axis: Chainsaw detections
  y = 'LARGIBBON',    # Y-axis: Gibbon detections
...
# Research questions ------------------------------------------------------
# Can try for 3-hr or 1-hr bins
# Relationship between chainsaws, gibbons, siamang
# Noise events lead to reduced calling events
# Sept to Nov 2022
